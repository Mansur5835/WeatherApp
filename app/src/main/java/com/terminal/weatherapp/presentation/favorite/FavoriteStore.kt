...
import com.terminal.weatherapp.domain.usecase.GetCurrentWeatherUseCase
import com.terminal.weatherapp.domain.usecase.GetFavoriteCitesUseCase
import com.terminal.weatherapp.presentation.favorite.FavoriteStore.Intent
import com.terminal.weatherapp.presentation.favorite.FavoriteStore.State
import com.terminal.weatherapp.presentation.favorite.FavoriteStore.Label
...
class FavoriteStoreFactory @Inject constructor(
    ...
    private val getFavoriteCitesUseCase: GetFavoriteCitesUseCase,
    ...
    private inner class BootstrapperImpl : CoroutineBootstrapper<Action>() {
        override fun invoke() {
            scope.launch {
                getFavoriteCitesUseCase().collect {
