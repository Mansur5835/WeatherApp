...
import com.terminal.weatherapp.presentation.search.SearchStore.Intent
import com.terminal.weatherapp.presentation.search.SearchStore.State
import com.terminal.weatherapp.presentation.search.SearchStore.Label
...
class SearchStoreFactory @Inject constructor(
    ...
    private inner class ExecutorImpl(val openReason: OpenReason) :
